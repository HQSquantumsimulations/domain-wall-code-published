...
# updated models
from models.XXXXZZ_with_CSS import Color666CodeXXXXZZ, BiasedDepolarizingErrorModel
from models.XXXXZZ_with_CSS import Color666MPSDecoderXXXXZZSimulated

# set models
codes = [Color666CodeXXXXZZ(size) for size in [3, 5, 7, 9]]
error_model = BiasedDepolarizingErrorModel(bias=3, axis='Z')
decoder = Color666MPSDecoderXXXXZZSimulated(chi=20)
...
error_probability_min, error_probability_max = 0.1, 0.3
